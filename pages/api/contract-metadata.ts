...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    const metadata = {
        name: copy.title,
        description: `${copy.heroSubheading}. <br><br> Part of **The Metagame**. Follow along on twitter [@Metagame](https://twitter.com/metagame). Mint one via [themetagame.xyz](https://www.themetagame.xyz) `,
